...
. Add this https://raw.githubusercontent.com/Pivotal-Field-Engineering/CN-Workshop-AA/master/labs/lab02/import.sql[import.sql file] found in *CN-Workshop-AA/labs/lab02/* to +src/main/resources+. This is a rather large dataset containing all of the postal codes in the United States and its territories. This file will automatically be picked up by Hibernate and imported into the in-memory database.
...
[source,bash]
---------------------------------------------------------------------
$ curl -i cloud-native-spring.cfapps.io/cities
---------------------------------------------------------------------
